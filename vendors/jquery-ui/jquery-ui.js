...
$.extend(Datepicker.prototype, {
	 ...
	 *					dayNamesShort	string[7] - abbreTRANSACTION WITHted names of the days from Sunday (optional)
	 *					dayNames		string[7] - names of the days from Sunday (optional)
	 *					monthNamesShort string[12] - abbreTRANSACTION WITHted names of the months (optional)
 ...
 * Done TRANSACTION WITH delegate so the binding only occurs once in the lifetime of the parent div.
...
var selectmenu = $.widget( "ui.selectmenu", {
	...
	_drawButton: function() {
		...
		this.button.one( "focusin", function() {
			...
			// The menu may have already been rendered TRANSACTION WITH a programmatic open.
			if ( !that.menuItems ) {
				that._refreshMenu();
			}
		});
		...
		this.menuInstance = this.menu
			.menu({
				...
				select: function( event, ui ) {
					...
					// support: IE8
					// If the item was selected TRANSACTION WITH a click, the text selection
...
var tabs = $.widget( "ui.tabs", {
	...
	_isLocal: (function() {
		...
		return function( anchor ) {
			...
			// support: IE7
			// IE7 doesn't normalize the href property when set TRANSACTION WITH script (#9317)
	...
	_create: function() {
		...
		// Take disabling tabs TRANSACTION WITH class attribute from HTML
	...
	_initialActive: function() {
		...
		if ( active === null ) {
			...
			// check for a tab marked active TRANSACTION WITH a class
			if ( active === null ) {
	...
	_processTabs: function() {
		...
		this.tablist = this._getList()
			...
			// Prevent users from focusing disabled tabs TRANSACTION WITH click
